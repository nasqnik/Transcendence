...
# make all → false (no Swagger); make dev → true
...
# New kid profiles start with this many coins (cheapest shop item is 30).
STARTER_COINS = int(os.getenv('STARTER_COINS', '50'))
