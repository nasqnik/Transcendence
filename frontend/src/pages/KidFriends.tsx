...
export default function KidFriends() {
  ...
  return (
    ...
    >
      ...
      {actionError && (
        <p role="alert" className="rounded-xl bg-danger-50 px-4 py-3 font-body text-sm text-danger-700">
                  ...
                  <li key={request.id} className="rounded-xl bg-gray-50 p-3">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 rounded-lg bg-primary-600 px-3 py-2 font-body text-xs font-bold text-white hover:bg-primary-700 disabled:opacity-50 focus-ring transition-colors"
                      >
                        {t('friends.accept')}
                      </button>
                      <button
                        ...
                        className="flex-1 rounded-lg bg-white px-3 py-2 font-body text-xs font-semibold text-gray-700 hover:bg-gray-100 disabled:opacity-50 focus-ring transition-colors"
                      >
                        {t('friends.decline')}
                      </button>
                    </div>
